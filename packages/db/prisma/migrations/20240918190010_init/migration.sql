...
-- CreateTable
CREATE TABLE "_MusiciansOperatingInNetwork" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateTable
CREATE TABLE "_BandsOperatingInNetwork" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateTable
CREATE TABLE "_NetworkToState" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "_OrganizersOperatingInNetwork" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_MusiciansOperatingInNetwork_AB_unique" ON "_MusiciansOperatingInNetwork"("A", "B");

-- CreateIndex
CREATE INDEX "_MusiciansOperatingInNetwork_B_index" ON "_MusiciansOperatingInNetwork"("B");
...
-- CreateIndex
CREATE UNIQUE INDEX "_BandsOperatingInNetwork_AB_unique" ON "_BandsOperatingInNetwork"("A", "B");

-- CreateIndex
CREATE INDEX "_BandsOperatingInNetwork_B_index" ON "_BandsOperatingInNetwork"("B");
...
-- CreateIndex
CREATE UNIQUE INDEX "_NetworkToState_AB_unique" ON "_NetworkToState"("A", "B");

-- CreateIndex
CREATE INDEX "_NetworkToState_B_index" ON "_NetworkToState"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_OrganizersOperatingInNetwork_AB_unique" ON "_OrganizersOperatingInNetwork"("A", "B");

-- CreateIndex
CREATE INDEX "_OrganizersOperatingInNetwork_B_index" ON "_OrganizersOperatingInNetwork"("B");
...
-- AddForeignKey
ALTER TABLE "Zipcode" ADD CONSTRAINT "Zipcode_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "State"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Region" ADD CONSTRAINT "Region_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "State"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Musician" ADD CONSTRAINT "Musician_basedInId_fkey" FOREIGN KEY ("basedInId") REFERENCES "Network"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Musician" ADD CONSTRAINT "Musician_basedInOldId_fkey" FOREIGN KEY ("basedInOldId") REFERENCES "City"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Band" ADD CONSTRAINT "Band_basedInId_fkey" FOREIGN KEY ("basedInId") REFERENCES "Network"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Band" ADD CONSTRAINT "Band_basedInOldId_fkey" FOREIGN KEY ("basedInOldId") REFERENCES "City"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Venue" ADD CONSTRAINT "Venue_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "State"("code") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Organizer" ADD CONSTRAINT "Organizer_basedInId_fkey" FOREIGN KEY ("basedInId") REFERENCES "Network"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Organizer" ADD CONSTRAINT "Organizer_basedInOldId_fkey" FOREIGN KEY ("basedInOldId") REFERENCES "City"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "State"("code") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_MusiciansOperatingInNetwork" ADD CONSTRAINT "_MusiciansOperatingInNetwork_A_fkey" FOREIGN KEY ("A") REFERENCES "Musician"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_MusiciansOperatingInNetwork" ADD CONSTRAINT "_MusiciansOperatingInNetwork_B_fkey" FOREIGN KEY ("B") REFERENCES "Network"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_BandsOperatingInNetwork" ADD CONSTRAINT "_BandsOperatingInNetwork_A_fkey" FOREIGN KEY ("A") REFERENCES "Band"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BandsOperatingInNetwork" ADD CONSTRAINT "_BandsOperatingInNetwork_B_fkey" FOREIGN KEY ("B") REFERENCES "Network"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_MusicGroupsPerformInCities" ADD CONSTRAINT "_MusicGroupsPerformInCities_A_fkey" FOREIGN KEY ("A") REFERENCES "Band"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_MusicGroupsPerformInCities" ADD CONSTRAINT "_MusicGroupsPerformInCities_B_fkey" FOREIGN KEY ("B") REFERENCES "City"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_OrganizerToState" ADD CONSTRAINT "_OrganizerToState_B_fkey" FOREIGN KEY ("B") REFERENCES "State"("code") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_NetworkToState" ADD CONSTRAINT "_NetworkToState_A_fkey" FOREIGN KEY ("A") REFERENCES "Network"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_NetworkToState" ADD CONSTRAINT "_NetworkToState_B_fkey" FOREIGN KEY ("B") REFERENCES "State"("code") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_OrganizersOperatingInNetwork" ADD CONSTRAINT "_OrganizersOperatingInNetwork_A_fkey" FOREIGN KEY ("A") REFERENCES "Network"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_OrganizersOperatingInNetwork" ADD CONSTRAINT "_OrganizersOperatingInNetwork_B_fkey" FOREIGN KEY ("B") REFERENCES "Organizer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
