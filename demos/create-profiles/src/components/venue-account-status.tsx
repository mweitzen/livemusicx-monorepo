  ...
  return existingVenue ? (
    existingVenue.accountManagerId ? (
      ...
      <div className='flex flex-col gap-6 text-center'>
        ...
        <p className='justify-center leading-loose'>
          Your account will likely already be populated with information. This
          shouldn't be a concern, we just wanted to let you know. Most of the
          venue info comes from Google, but you will want to double check it
          anyway.
        </p>
    ...
    <>
      <div className='text-center'>
        ...
        <p className='text-2xl font-medium justify-center'>
          No Existing Account
        </p>
        <p className='text-sm text-muted-foreground justify-center'>
          You are creating a brand new venue. If this is your first venue,
          welcome! If it isnt, welcome back. :)
        </p>
      </div>
      <div className='flex flex-col gap-2'>
        <p className='text-sm justify-center'>
