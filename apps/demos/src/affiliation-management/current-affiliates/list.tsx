  ...
  return (
    <AdminTabs defaultValue={userType === "VENUE" ? "organizers" : "venues"}>
      <AdminTabsList className="grid-cols-3">
        <AdminTabsTrigger value="venues" hidden={userType === "VENUE"}>
          Venues
        </AdminTabsTrigger>
        <AdminTabsTrigger value="organizers" hidden={userType === "ORGANIZER"}>
          Organizers
        </AdminTabsTrigger>
        <AdminTabsTrigger value="performers" hidden={userType === "PERFORMER"}>
          Performers
        </AdminTabsTrigger>
        <AdminTabsTrigger value="requests">Requests</AdminTabsTrigger>
      </AdminTabsList>
      <AdminTabsContent value="venues" hidden={userType === "VENUE"}>
        <Card className="p-6">
      ...
      <AdminTabsContent value="organizers" hidden={userType === "ORGANIZER"}>
        <Card className="p-6">
          <Input type="search" placeholder="Search organizers" />
        </Card>
        <Card className="p-6">
          <p>Organizers</p>
        </Card>
      </AdminTabsContent>
      <AdminTabsContent value="performers" hidden={userType === "PERFORMER"}>
        <Card className="p-6">
          <Input type="search" placeholder="Search performers" />
        </Card>
        <Card className="p-6">
          <p>Performers</p>
        </Card>
